...
import imgLogo from '../../assets/img/logotitle.png';

const Sidebar = () => {

  const [siderBarSide, setSideBarSide] = useState("translateX(240")

  const mobileState: boolean = window.innerWidth >= 760 ? false : true;
  ...
  const MobliSiderBar = () =>
  (<div className="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out"
    id="mobile-nav">
    <button
      ...
      onClick={() => setSideBarSide("translateX(0px)")}
    >
    ...
    <button aria-label="Close sidebar"
      ...
      onClick={() => setSideBarSide("translateX(260px)")}>
  ...
  const SereachBox = () => (
    <div>
      <ul className="mt-6 px-8">
        <li className="flex justify-center mt-4 mb-4 w-full">
          <div className="relative">
            <div className="text-gray-300 absolute ml-4 inset-0 m-auto w-4 h-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-search" width="16" height="16" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z"></path>
        ...
        <li className=" border-t border-gray-700">
          <div className="flex items-start items-center mb-4 mt-5">
            ...
            <label className="text-sm ml-3 font-medium text-gray-50">My Sell</label>
          </div>
          <div className="flex items-start items-center mb-4 mt-5">
            <input id="checkbox-2" aria-describedby="checkbox-2" type="checkbox" className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded" />
            <label className="text-sm ml-3 font-medium text-gray-50">50$ over</label>
          </div>
          <div className="flex items-start items-center mb-4 mt-5">
            <input id="checkbox-2" aria-describedby="checkbox-2" type="checkbox" className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded" />
            <label className="text-sm ml-3 font-medium text-gray-50">100% over</label>
          </div>
        </li>
      </ul>
    </div>
  ...
  const DataBox = () => (<div>
    <ul>
      <div className="mt-4 border-t border-gray-700">
        <li className="flex w-full justify-center text-gray-300 cursor-pointer items-center mt-3">
          <a className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
              <path stroke="none" d="M0 0h24v24H0z"></path>
              <rect x="4" y="4" width="6" height="6" rx="1"></rect>
            ...
            <span className="text-sm ml-2">My Joy Balance</span>
          </a>
        </li>
        <li className="flex w-full justify-center text-gray-300 cursor-pointer items-center mt-1">
          <div className="py-1 px-3 bg-gray-50 rounded text-slate-900 flex items-center justify-center text-xs">50000 joy</div>
        </li>

        <li className="flex w-full justify-center text-gray-400 hover:text-gray-300 cursor-pointer items-center mt-5">
          <a className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-puzzle" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
              <path stroke="none" d="M0 0h24v24H0z"></path>
              <path d="M4 7h3a1 1 0 0 0 1 -1v-1a2 2 0 0 1 4 0v1a1 1 0 0 0 1 1h3a1 1 0 0 1 1 1v3a1 1 0 0 0 1 1h1a2 2 0 0 1 0 4h-1a1 1 0 0 0 -1 1v3a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-1a2 2 0 0 0 -4 0v1a1 1 0 0 1 -1 1h-3a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h1a2 2 0 0 0 0 -4h-1a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1"></path>
            </svg>
            <span className="text-sm ml-2">My Dote balance</span>
          </a>
        </li>
        <li className="flex w-full justify-center text-gray-300 cursor-pointer items-center mt-1">
          <div className="py-1 px-3 bg-gray-50 rounded text-slate-900 flex items-center justify-center text-xs">50000 joy</div>
  ...
  const FooterBox = () => (
    <div className="px-8 border-t border-gray-700 mt-4">
      <ul className="w-full flex items-center justify-between bg-gray-800">
        <li className="cursor-pointer text-white pt-5 pb-3">
          <button aria-label="show notifications" className="focus:outline-none focus:ring-2 rounded focus:ring-gray-300">
            <img src={imgSeller} alt="img logout" height={"30px"} width={"30px"} />
          </button>
        </li>
        <li className="cursor-pointer text-white pt-5 pb-3">
          <button aria-label="open chats" className="focus:outline-none focus:ring-2 rounded focus:ring-gray-300">
            <img src={imgWithdraw} alt="img logout" height={"30px"} width={"30px"} />
          </button>
        </li>
        <li className="cursor-pointer text-white pt-5 pb-3">
          <button aria-label="open settings" className="focus:outline-none focus:ring-2 rounded focus:ring-gray-300">
            <img src={imgLogout} alt="img logout" height={"30px"} width={"30px"} />
          </button>
        </li>
